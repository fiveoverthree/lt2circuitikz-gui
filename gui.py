...
class App(TKMT.ThemedTKinterFrame):
    def __init__(self):
        ...
        self.Button("Open file", self.load) #the button is dropped straight into the frame
        self.run()
        self.text = None
        self.text_area = None
    ...
    def updateText(self):
        ...
        self.text_area.grid(column=0, row=1, padx=5, pady=5)
    ...
    def drawCopyButton(self):
        ...
        copy_button.grid(column=0, row=2, padx=5, pady=5)
